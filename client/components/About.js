      ...
      <AnimatedPage>
        <div style={{ marginTop: "90px" }}>
          ...
          <ul id="categories" className="clr" style={{ marginTop: "90px" }}>
            ...
            <li>
              <div>
                <img src="./photos/ice.jpeg" alt="" />
                <h1>Ice Tam</h1>
                <p>
                  <a
                    id="fork"
                    target="_blank"
                    href="https://github.com/IceTam1"
                  >
                    My GitHub
                  </a>
                </p>
            ...
            <li>
              <div>
                <img src="./photos/jacob.jpeg" alt="" />
                <h1>Jacob Park</h1>
                <p>
                  <a
                    id="fork"
                    target="_blank"
                    href="https://github.com/Jacob-H-Park"
                  >
                    My GitHub
                  </a>
                </p>
            ...
            <li>
              <div>
                <img src="./photos/rob.png" alt="" />
                <h1>Robert Albenda</h1>
                <p>
                  <a
                    id="fork"
                    target="_blank"
                    href="https://github.com/robbo1987"
                  >
                    My GitHub
                  </a>
                </p>
            ...
            <li>
              <div>
                <img src="./photos/kenneth.png" alt="" />
                <h1>Kenneth Lee</h1>
                <p>
                  <a
                    id="fork"
                    target="_blank"
                    href="https://github.com/kennethlee0502"
                  >
                    My GitHub
                  </a>
                </p>
